  ...
  return (
    <>
      <Box style={{margin: theme.spacing(2)}}>
        ...
        <Typography 
        variant='body1' color='secondary.dark'>
      ...
      {/* sx 속성 사용 */}
      <Box sx={{ 
        color: 'primary.contrastText', backgroundColor: 'primary.dark', width: 100, borderRadius: 8, '@media (min-width: 600px)': {width: 250, fontSize: 40},
