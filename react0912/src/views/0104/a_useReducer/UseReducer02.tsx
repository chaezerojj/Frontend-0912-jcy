            ...
            {isEditing === todo.id ? (
              ...
              <button
                onClick={() => {
                  ...
                  editTodoText.onchange({ target: {value: ''}} as React.ChangeEvent<HTMLInputElement>);
                }}>Edit</button>
            )}
            <button
              onClick={() => 
