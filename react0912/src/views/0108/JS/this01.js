...
let user = {
  ...
  greet: function() {
    // this.name은 user객체의 name 프로퍼티를 참조
...
// 1. call()
// : 첫 번째 인자로 this값을 설정, 이후의 인자들은 호출될 함수의 인자로 전달
function introduce(name, profession) {
  console.log("제 이름은 " + name + "이고, 직업은 " + profession + "입니다.");
}
