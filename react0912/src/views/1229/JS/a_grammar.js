...
const person = { name: 'jcy', age: 25, height: 170, gender: 'female' };
...
// , 복사한 배열을 수정하면 기존 배열 또한 똑같이 수정
// : 스프레드 연산자로 복사하는 경우 요소값만을 새로운 배열에 할당
console.log(arr1); 
