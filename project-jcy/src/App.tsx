...
// : 사용자가 웹앱 내에서 다른 페이지로 이동할 때, 새로운 페이지를 서버로부터 로드하는 대신 클라이언트 사이드에서 라우팅처리를 하는 방법
...
//! 라우팅(Routing)
// : 웹앱에서 사용자가 요청하는 url을 화면의 특정 컴포넌트에 연결
...
// BrowserRouter: Route 기능을 사용할 제일 루트 단위의 컴포넌트를 묶는 과정
...
//! 기본 Route들을 묶는 Routes 사용

//! URL과 컴포넌트 연결하는 Route 작성
// path속성: App.tsx 연결 시 작성되는 localhost:3000 경로 뒤에 작성되는 url경로 작성
// ex) /login, /signup, /bookDetail
