...
console.log(name); // 진채영

// let
// : 블록 레벨 스코프
// : 함수 외의 {}(코드 블록)이 작성되는 영영에서는 그 스코프 가짐
// : 재선언 불가능, 재할당 가능
let age = 28;
{let age = 30;}
age = 40;
...
// - a && b에서 a값이 false인 경우 b의 값을 계산X
// a 쿠키(회원 정보 있을 경우 true, 없을 경우 false)
// b 모든 회원이 접근 가능/ 회원만 접근할 수 있는 페이지
// a가 false라면(회원X) 
// >> 회원만 접근할 수 있는 페이지 렌더링X
...
//? 2. || 연산자
// : a || b 연산자
// : a의 값에 상관없이 무조건 b의 계산을 진행
true || console.log("무조건 출력");
// a의 값에 대한 논리 뿐 아니라 b의 결과식도 계산해야 하는 경우
