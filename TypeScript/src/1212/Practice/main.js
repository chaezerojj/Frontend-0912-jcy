...
- 페이지 간에 이동은 버튼(Previous, Next)으로 함
...
};
{
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // slice 메소드
                        // : 배열 메소드, 배열의 특정 메소드를 새로운 배열로 반환
                        // (page - 1) * photoPerPage
                        // : 페이지 번호는 1부터 시작이지만, 인덱스 번호는 0부터 시작하기 때문에 -1을 한 번호에
                        // : 페이지 당 사진 수를 곱하여, 현재 페이지의 첫 번째 사진이 배열에서 몇번째 위치에 있는지 계산
                        // page * photoPerPage
                        // : 현재 페이지의 마지막 사진 다음의 인덱스를 계산
                        return [2 /*return*/, photos.slice((page - 1) * photoPerPage_1, page * photoPerPage_1)];
                }
            });
        });
    }
    ...
    function renderPhotos(photos) {
        ...
        photos.forEach(function (photo) {
            ...
            photoElem.innerHTML = "<img src = '".concat(photo.thumbnailUrl, "' alt='").concat(photo.title, "' /> <p>").concat(photo.title, "</p>");
    ...
    function updatePhotos() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetchPhotos(currentPage_1)];
                    case 1:
                        photos = _a.sent();
                        // 불러온 사진들을 화면에 렌더링
                        renderPhotos(photos);
