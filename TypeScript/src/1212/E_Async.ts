...
//? 사용방법
// async 함수 내부에서만 await를 사용할 수 있다.
...
async function fetchPostByPage(page: number, limit: number = 10): Promise<any[]> {
  try {
    // 요청 전달
...
fetchPostByPage(1, 5).then(posts => console.log('페이지 1의 게시물: ', posts));
