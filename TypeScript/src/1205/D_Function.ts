...
// ...연산자를 매개변수 앞에 사용하고 정의
function sum(...numbers: number[]): number {
  // reduce 메소드
  // : 네 개의 매개변수를 가질 수 있음.
  // 누적계산의 결과값: accumulator
...
//! 함수의 오버로딩
// : 같은 이름의 함수에 대해 여러 매개변수 타입과 반환타입을 정의하는 기능
//? 특징
// : 함수는 '하나 이상의 타입 시그니처'를 가질 수 있음
// : 함수는 '단 하나의 구현'을 가질 수 있음
