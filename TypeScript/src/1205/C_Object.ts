...
// : , 키와 값의 차이만을 정의하여 객체의 구조를 유연하게 지정하는 방법
// : 객체의 속성에 동적으로 접근할 수 있는 기능

// 장점
// - 유연성: 정해진 속성 이름 없이 다양한 속성을 객체에 추가 기능
...
type UserRecord = {
  ...
  // 문자열 키를 가지며, 각 키의 값도 문자열 타입으로 지정되어야 함
  [key: string]: string;
  // [key: number]: string;
}
...
users['firstName'] = 'Lee';
console.log(users.firstName); // Lee
}