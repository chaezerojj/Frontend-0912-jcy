...
//? 클래스의 특징
// 캡슐화 : 데이터(속성)와 데이터를 처리하는 함수(메소드)를 하나로 묶는 것
// 추상화 : 복잡한 세부사항X, 필수적인 부분만을 강조하는 것
// 상속 : 한 클래스의 속성과 메소드를 다른 클래스가 상속받을 수 있는 것
...
//? 객체의 특징
// 상태와 행동 : 객체는 속성(상태)과 메소드(행동)을 갖는 것
// 독립성 : 각 객체는 독립적인 성격을 가지며 다른 객체와 상호작용
