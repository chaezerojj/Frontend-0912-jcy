...
// : static 메소드 내에서는 this 키워드를 사용하여 접근할 수 X

// : 인스턴스별로 데이터를 유지할 필요가 없는 공통 기능 미 데이터에 적합
...
console.log(employee.fullName); // Lee Seung Ah
