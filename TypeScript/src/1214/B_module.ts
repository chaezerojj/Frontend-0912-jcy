...
// >> 각 파일에 export {};을 사용하는 경우, 해당 파일이 모듈화됨
...
// 2. 모듈 불러오기 (Import)
// : 다른 모듈에서 내보낸 요소를 가져올 때 사용
// import {모듈명} from '파일루트'

// 3. Default 모듈 내보내기
// : 하나의 모듈에서 '단 하나의 기능이나 객체'를 기본적으로 내보내고 싶을 때 사용
// : export default 키워드를 사용
// 주로 하나의 모듈에 하나의 주요 기능이 있는 경우에 적합
export default class Calculature {
