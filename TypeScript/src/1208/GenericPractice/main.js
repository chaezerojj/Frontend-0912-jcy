{
    ...
    var TaskManager_1 = /** @class */ (function () {
        ...
        TaskManager.prototype.renderTask = function (containerId) {
            var _this = this;
    ...
    window.onload = function () {
        var taskManager = new TaskManager_1(); // 문자열 타입의 할일 관리자 생성
        ...
        addButton.onclick = function () {
            ...
            // 할 일 목록을 화면에 렌더링
            taskManager.renderTask('task-list');
            // 입력 필드 초기화
            newTaskInput.value = '';
        };
    };
