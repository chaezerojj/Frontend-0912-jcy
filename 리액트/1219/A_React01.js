...
: 개발자가 모델, 컨트롤러는 외부 라이브러리에서 다운받아서 가져와서 사용
...
: 전체 페이지를 새로고침하지 않고도 사용자와 상호작용에 반응하여 
  동적으로 콘텐츠를 업데이트하는 것을 목표로 하는 웹 애플리케이션 접근방식

? 리액트를 사용한 SPA 구현
- 가상 돔을 사용하기 때문에 페이지 전체를 새로고침하지 않고 필요한 부분만 업데이트
