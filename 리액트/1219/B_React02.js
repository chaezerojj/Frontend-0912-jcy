...
? 설치
- CRA 페이지 접속 > get started 클릭 > template 설정
...
- 대부분 git에 업로드할 때 관리되지 않도록 설정
- 해당 프로젝트를 클론한 경우 npm install을 사용하여 필요한 모듈들을 재설치

? node_modules 깃 업로드 방지 방법
: 최상위 디렉토리에 .gitignore 파일 생성
: 업로드 하고싶지않은 파일의 확장자 또는 파일명을 작성
: # node_modules 파일 무시
: node_modules/
별/node_modules
