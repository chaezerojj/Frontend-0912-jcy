...
// forEach() 메소드
// : 순회 메소드
// : , 배열의 각 요소에 대해서 제공된 callback함수를 오름차순 인덱스 순서로 한번씩 호출

// : 배열이 가지고 있는 함수(메소드)로써 단순하게 배열 내부의 요소를 사용해서 콜백함수를 호출

// 배열이 가지고 있는 메소드 중에서
// , 콜백 함수를 활용하는 메소드의 형태
// : function (value, index, array) { }
// : 3가지 매개변수를 반드시 모두 작성할 필요 X

const members = [253, 52, 103, 32, 57];
...
console.log('----map()----');
//! 콜백함수를 활용하는 함수: map() (중요!!!)
// : 콜백함수에서 리턴한 값들을 기반으로 새로운 배열을 만드는 함수
// : 수정할 때 주로 사용

let numbers = [253, 52, 103, 32, 57];
