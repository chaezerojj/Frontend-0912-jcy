...
console.log(createArray(1, 2, 3, 4, 5));    // (5) [1, 2, 3, 4]

// Math.min()함수
// : 복수의 인자를 받아 그 중 최소값을 반환
function findMin(...numbers) {
  //numbers 배열을 Math.min에 전달하여 최소값 반환
...
console.log(isLeapYear(2000)); // 2020년이 윤년인지 확인
...
console.log(calculatePay(10000)); //시급 10000원에 기본값 사용(40)
console.log(calculatePay(15000, 50)); // 시급 15000원 50시간 근무