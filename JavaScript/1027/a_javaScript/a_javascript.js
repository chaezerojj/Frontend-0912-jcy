...
! 자바스크립트 소개
  ...
  - html
    : 웹 콘텐츠를 구성하고 의미를 부여하는데 사용하는 마크업 언어
  - css
    : HTML 콘텐츠에 스타일을 적용하는데 사용하는 스타일 규칙 언어

  - javaScript
    : 서버나 웹에서 작동하는 프로그램을 만드는 등 
      웹의 모든 부분을 다룰 수 있는 스크립팅 언어이자 
      프로그래밍 언어
  ...
  ! 자바 스크립트의 활용
    ...
    3. 모바일 애플리케이션 개발
      안드로이드 - 자바, 코틀린
      아이폰 - 스위프트
      리액트: '페이스북'에서 자바스크립트로 모든 모바일 운영체제에서 
              사용 가능한 리액트 네이티브 개발
  ...
  ! 자바 스크립트의 주요 기능
    == 자료첨부 (이론, 읽어보면 좋은 배경 지식)
*/

// 현재 웹 페이지에서 첫번째 button 태그를 찾아서 저장
// 같다: ==
// 우항의 값을 좌항에 넣는다.: =
