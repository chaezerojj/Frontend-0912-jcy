...
console.log(computer2); // 'Samsung Book3'
...
console.log(computer3.name); // SamSung Book3 Ultra
...
// 깊은 복사
// : 원복 객체의 값을 완전히 복제하여 새로운 객체를 생성 >> 원본 객체와 복사본이 서로 독립적
let animal3 = JSON.parse(JSON.stringify(animal1));
// JS에서는 깊은 복사를 위해 JSON.parse(JSON.stringify(object));를 사용
...
//! 자바스크립트 속성 존재 확인
// 속성이 객체에 존재하는지 확인을 하기 위해서 in 연산자 사용
...
// delete 연산자를 사용하여 삭제
delete book.author;
console.log('author' in book); // false (삭제됨)
