...
// : 중괄호를 사용하여 그 안에 키와 값이 콜론(:)으로 구분되는 속성
...
//! 6. 객체 멤버 설정
// : 객체 멤버 가져오기(반환)방법과 동일하게 점 표기법과 대괄호 표기법을 사용
console.log(person.age);
person.age = 45;
person['name']['first'] = 'jungbok';

console.log(person.age); // 45
console.log(person['name']['first']); // jungbook

// 객체 멤버를 설정하는 것은
// 기존의 존재하는 프로퍼티나 메소드를 새롭게 정의하는 것뿐만 아니라
// , 완전히 새로운 멤버 생성도 가능
...
// >> 점 표기법: 멤버의 이름을 동적으로 사용 X, 상수값만을 사용하는 것을 권장
