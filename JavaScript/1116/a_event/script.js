...
// - btn.ondblclick: 오직 버튼이 더블클릭 되었을 때만 실행
...
function bgChange() {
  ...
  function random(number) {
    ...
    // Math.random(): 0 이상 1 미만의 부동 소수점 난수(랜덤 숫자)를 반환
...
// 여러 개의 버튼의 참조를 모두 가져와 한번에 이벤트 핸들러를 추가
...
// * addEventListener() 함수의 2가지 매개변수
// 첫번째 매개변수 : 이벤트 유형(등록하고자 하는 이벤트의 이름 / 예 - click, load, input 등)
// 두번째 매개변수 : 이벤트 핸들러 함수
