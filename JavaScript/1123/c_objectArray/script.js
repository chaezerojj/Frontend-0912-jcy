...
console.log(name, price); // 어린 왕자 10620

// name속성을 aaa라는 이름, price속성을 bbb라는 이름으로 꺼내옴
const { aaa=name, bbb=price } = object;
console.log(aaa, bbb); // 어린 왕자 10620

//! 4. 배열 전개 연산자
// : 배열과 객체는 할당할 때 얕은 복사가 이루어짐.

// 사야하는 물건 목록
const basket_1123 = ['우유', '식빵'];
const basket_1124 = basket_1123;

basket_1123.push('고구마');
basket_1124.push('토마토');

// 출력
console.log(basket_1123); // ['우유', '식빵', '고구마', '토마토']
console.log(basket_1124); // ['우유', '식빵', '고구마', '토마토']
...
const basket_1125 = [...basket_1123];
basket_1125.push('치즈');
console.log(basket_1123);

// 전개 연산자를 사용한 배열 요소 추가
// [...배열, 자료, 자료, 자료]
const more = ['감자, 오렌지주스']
const basket_1126 = ['양파', ...basket_1125, ...more];
console.log(basket_1126);
...
console.log(JSON.stringify(puppyB)); // 둘다 같은 객체에 값 재할당
