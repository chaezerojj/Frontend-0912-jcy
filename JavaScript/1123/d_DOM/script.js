...
// : 웹페이지의 요소를 선택, 추가, 수정, 삭제하는데 사용할 수 있는 메소드와 속성에 접근이 가능
...
// DOMContentLoaded이벤트는 웹 브라우저가 문서 객체를 모두 읽고 나서 실행하는 이벤트
// : 문서 객체가 정립된 이후에 콜백함수가 실행되기 때문에 오류 방지에 이점

//! 4. 문서 객체 가져오기
//? document.body
// : 문서의 body요소를 읽어들이는 코드
// : body외에도 head요소, title 요소 등도 읽어오기 가능
