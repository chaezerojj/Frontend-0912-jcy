...
console.log(stringA); // 줄바꿈한 값 그대로 출력됨
console.log(stringB); // 띄어쓰기 값 그대로 출력됨

console.log(stringA.trim()); // 줄바꿈 값 없어짐
console.log(stringB.trim()); // 띄어쓰기 값 없어짐
...
02,1141.7,1096.46,1263.37
02,1141.6,1095.46,1264.37
02,1441.5,1094.46,1265.37
02,1141.4,1093.46,1266.37
`;
...
// split()메소드로 반환되는 데이터는 배열로 생성되어 반환
console.log(manyData);
