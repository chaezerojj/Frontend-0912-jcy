...
//! 3. JSON 객체
// JavaScript Object Natation (자바스크립트 객체 표기법)
...
// : 형태 자체는 js의 객체와 유사하지만, json은 순수한 텍스트 형식이기 때문에 키를 항상 따움표로 묶어야 함.
// : 값에는 함수 등은 사용 불가
// : 문자열은 큰따옴표 사용을 권장
...
// : 데이터에 바로 적용X - JSON객체에 사용
console.log(JSON.stringify(data));
// JSON.stringfy()의 2번째 매개변수
// : 객체에서 어떤 속성만 선택해서 추출하고 싶을 때 사용
// : 거의 사용하지 X (일반적으로 null을 사용)

// JSON.stringfy()의 3번째 매개변수
// : 들여쓰기 N칸 설정
...
console.log(now.getDay()); // 4(목요일의 값을 반환)