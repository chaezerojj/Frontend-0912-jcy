...
document.addEventListener('DOMContentLoaded', () => {
  ...
  rects.forEach((rect, index) => {
    ...
    const source = `./kitten-4611189_1280.jpg`;
    // set과 getAttribute()메소드를 사용하지 않고도
    // , 해당 요소에 .속성 으로 바로 읽기 가능
    rect.src = source;
    //rect.getAttribute('src', src);
  })
})
