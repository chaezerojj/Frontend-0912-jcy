...
// if문과 else문 사이에 위치, 여러 개의 조건을 확인할 수 있게 해주는 제어구조
...
// 표현식의 값을 확인하고 해당 값과 일치하는 case문의 코드블록을 실행
...
// switch (식) {
//  case 값1:
//           식이 값1과 일치할 대 실행되는 코드
//           break;
//  case 값2:
//           식이 값2과 일치할 대 실행되는 코드
//           break;
//         ...
//         default:
...
// 위 충접 if문을 삼항 연산자로 변환
score = 85;

let grade =
// 100점 초가 0점 미만의 점수는 존재하지 않음.
...
// >> 첫번째 조건식이 false면, 두 번째 조건식은 체크하지 않고 바로 false
// and 연산자 사용시 false가 될 확률이 높은 조건을 첫번째 조건식으로 사용하는 것을 권장

// or 연산자는 조건식이 둘 이상일 경우
// , 하나면 true여도 최종 결과값이 true

// >> true가 될 확률이 높은 조건식을
// 첫번째 조건식으로 사용하는 것을 권장